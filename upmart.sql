...
--
-- Host: 127.0.0.1
-- Generation Time: May 18, 2018 at 07:37 PM
...
INSERT INTO `banner` (`id_banner`, `url_banner`, `kategori`) VALUES
(3, '../../assets/banner/azCumlyiPA.jpeg', 6),
(4, '../../assets/banner/LDLUkkpoEs.jpeg', 5);
...
CREATE TABLE `pemberitahuan` (
  `id_pemberitahuan` int(10) NOT NULL,
...
INSERT INTO `pemberitahuan` (`id_pemberitahuan`, `isi`, `status`, `tanggal`, `waktu`, `email_penerima`) VALUES
(1, 'pembayaran berhasil', 0, '18-05-2018', '18:56:44', 'hhizari@gmail.com');
...
('hhizari@gmail.com', '../../assets/user/UzmsjdPGwd.jpeg', 'Hudio Hizari', '085822333459', '1619d7adc23f4f633f11014d2f22b7d8', 'alamat baru dengan tambahan', 50000, 0);
...
CREATE TABLE `ulasan` (
  ...
  `waktu` varchar(100) NOT NULL,
  `status` int(1) NOT NULL,
  `email_pengulas` varchar(100) NOT NULL,
  `id_barang` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `ulasan` (`id_ulasan`, `bintang`, `isi`, `tanggal`, `waktu`, `status`, `email_pengulas`, `id_barang`) VALUES
(3, 5, 'sangat bagus gan', '18-05-2018', '17:32:42', 0, 'hhizari@gmail.com', 5),
(4, 1, 'sangat jelek gan', '18-05-2018', '17:33:39', 0, 'hhizari@gmail.com', 5);
...
ALTER TABLE `pemberitahuan`
  ...
  ADD KEY `fk_email_penerima_pemberitahuan` (`email_penerima`);
...
ALTER TABLE `ulasan`
  ...
  ADD KEY `fk_email_pengurus` (`email_pengulas`),
  ADD KEY `fk_id_ulas_barang` (`id_barang`);
...
--
ALTER TABLE `pemberitahuan`
  MODIFY `id_pemberitahuan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `ulasan`
  MODIFY `id_ulasan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `pemberitahuan`
  ADD CONSTRAINT `fk_email_penerima_pemberitahuan` FOREIGN KEY (`email_penerima`) REFERENCES `pengguna` (`email`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `ulasan`
  ADD CONSTRAINT `fk_email_pengurus` FOREIGN KEY (`email_pengulas`) REFERENCES `pengguna` (`email`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_id_ulas_barang` FOREIGN KEY (`id_barang`) REFERENCES `barang` (`id_barang`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
